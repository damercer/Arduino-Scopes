//QT Py Scope3 1/2/3 channel scope 1 internal awg (1/18/2024)
//
...
uint8_t scopea[4096]; // Max Samples 1700
uint8_t scopeb[4096];
uint8_t scopec[4096]; 
uint8_t digin[2048];
short awgouta[2048];
...
void setup() {
  ...
  at=25;
  int Ain1;
  Ain1 = 1; // pin number for A1
  int Ain2;
  Ain2 = 4; // pin number for A2
  int Ain3;
  Ain3 = 5; // pin number for A3
  //
  //pinMode(A1, INPUT);
  //pinMode(A2, INPUT);
  //pinMode(A3, INPUT);
