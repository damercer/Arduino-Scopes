//Pico_Scope3 3 channel scope with AWG using MCP48x2 dual 8/10/12 bit SPI DAC 
    ...
    if (Serial.available()){
      ...
      switch (c){
        ...
        case 'L': // load AWG A Buffer data
          ...
          awgouta[addr] = data | 0b0101000000000000; // address DACA 2X REF
          break;
        case 'l': // load AWG B Buffer data
          ...
          awgoutb[addr] = data | 0b1101000000000000; // address DACB 2X REF
          break;
