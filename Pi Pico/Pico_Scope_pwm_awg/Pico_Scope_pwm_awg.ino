...
void setup1() {
  ...
  ampla = 127; // default is 127 or full 0 to 255 peak to peak
  ...
  amplb = 127; // default is 127 or full 0 to 255 peak to peak
    ...
    if (Serial.available()){
      ...
      switch (c){
        case 'I': // read back FW Rev
          Serial.println ("Pi Pico Scope PWM 3.0");
          break;
        ...
        case 'L': // load AWG A Buffer data
          ...
          awgouta[addr] = data; // address DACA
          break;
        case 'l': // load AWG B Buffer data
          ...
          awgoutb[addr] = data; // address DACB
          break;
