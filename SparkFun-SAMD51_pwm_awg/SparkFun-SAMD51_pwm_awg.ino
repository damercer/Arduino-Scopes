//SparkFun SAMD51 Thing Plus Scope3 1/2/3 channel scope 1 internal awg 
// (1/11/2024)
...
void setup() {
  ...
  analogWrite(A0, 0); // DAC 0 outputs on board pin A0
  analogWrite(A1, 0); // DAC 1 outputs on board pin A4
    ...
    if (Serial.available()){
      ...
      switch (c){
        case 'I': // read back FW Rev
          Serial.println ("SparkFun Thing Plus Scope 3.0");
          break;
